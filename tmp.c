        ...
        */
        //if(ntohs(eh->h_proto) == ETH_P_ARP)
        {
            ...
            */
            ...
            ah->arp_dpa[0] = buf_arp_dpa[0];
            ah->arp_dpa[1] = buf_arp_dpa[1];
            ah->arp_dpa[2] = buf_arp_dpa[2];
            ah->arp_dpa[3] = buf_arp_dpa[3];
            ...
            if((ah->arp_spa[0]==10 && ah->arp_spa[1]==0 && ah->arp_spa[2]==0
&& ah->arp_spa[3]==1))
            printf("TARGET MAC address: %02X:%02X:%02X:%02X:%02X:%02X\n",
                ah->arp_dha[0],
                ah->arp_dha[1],
